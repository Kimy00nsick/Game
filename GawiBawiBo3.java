...
public class GawiBawiBo3 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(user.getIcon().equals(img_btn[computer])){
            label_comSide.setIcon(img_btnIcon[computer]);
            label_userSide.setIcon(img_btnIcon[computer]);
            ...
            draw++;
                ...
                user.getIcon()==img_btn[2] && computer==1){
                    for(int i=0;i<img_btn.length;i++)if(user.getIcon()==img_btn[i])label_userSide.setIcon(img_btnIcon[i]);
                    win++;
                    label_comSide.setIcon(img_btnIcon[computer]);
                    label_com.setIcon(img_loser);
    ...
    public static void main(String[] args) {
        GawiBawiBo3 obj = new GawiBawiBo3();
